...
using Infrastructure.Tests.Integration.Binance.BinanceFuturesServiceTests.Base;

namespace Infrastructure.Tests.Integration.Binance.BinanceFuturesServiceTests.ShortPositions;

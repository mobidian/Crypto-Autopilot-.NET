...
namespace Infrastructure.Tests.Integration.Binance.BinanceFuturesTradingServiceTestsBase.Base;
...
public abstract class BinanceFuturesTradingServiceTestsBase
{
    ...
    public BinanceFuturesTradingServiceTestsBase()
    {
        ...
        this.SUT = new BinanceFuturesTradingService(this.CurrencyPair, 10, this.FuturesApiService, this.AccountDataProvider, this.MarketDataProvider, this.OrderStatusMonitor);
    }
